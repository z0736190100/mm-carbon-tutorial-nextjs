...
const infoCards = infoCardsContent.map((content, index) => (
  <InfoCard {...content} key={index} />
));

export default function HomePage() {
  return (
    <Grid className="home-page" fullWidth>
      <Column lg={16} md={8} sm={4} className="home-page__banner">
        ...
        <h1 className="landing-page__heading">
          Good Habit: Design &amp; build with Carbon
        </h1>
      </Column>
      ...
      <Column lg={16} md={8} sm={4} className="landing-page__r3">
        <InfoSection heading="The Principles">{infoCards}</InfoSection>
      </Column>
    </Grid>
  );
}
